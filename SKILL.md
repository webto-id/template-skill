...
- **The source's own licensed/branded fonts and images** — replaced with the nearest matched Google Font and Unsplash/Pexels/platform-illustration images; never redistribute the source's own asset files or a paid font's files.
